...
<body>
    ...
    <div class="container-fluid">
        <div class="row align-items-lg-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        @foreach ($cats as $cat)
                        <a href="{{ route('productbycat',['id'=>$cat->cat_id]) }}" class="nav-item nav-link">{{ $cat->cat_name }}</a>
                        @endforeach
                    </div>
                </nav>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('shop') }}" class="dropdown-item active">Shop</a>
                            <a href="{{ route('detail') }}" class="nav-item nav-link">About</a>
                            <a href="{{ route('contact') }}" class="nav-item nav-link">Contact</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            @php($wishcount = \App\Models\Wishlist::count())
                            <a href="{{ route('userwish') }}" class="btn px-0">
...
<div>
 ...
 <!-- Footer Start -->
    ...
    <script src="{{ url('user/mail/contact.j') }}s"></script>
