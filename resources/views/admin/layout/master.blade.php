        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('admin.product') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Products</a>
                    <a href="{{ route('admin.category') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Categories</a>
                    <a href="{{ route('admin.contact') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Contacts</a>
                    <a href="{{ route('admin.users') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Users</a>
                    <a href="{{ route('admin.bills') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Bills</a>
