    ...
    <div class="row g-4 justify-content-center">
        <div class="col-sm-12 col-xl-6">
            <div style="background-color: #121212; color: #ffffff; border-left: 5px solid #e50914; border-radius: 10px; box-shadow: 0 0 10px rgba(229, 9, 20, 0.15); padding: 20px;">
                <h5 class="mb-3" style="color: #e50914;">Edit Product</h5>
                ...
                <form enctype="multipart/form-data" action="{{ route('admin.updateproduct', ['id' => $product->product_id]) }}" method="POST">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="proName" name="pro_name"
                            value="{{ old('pro_name', $product->product_name) }}"
                            placeholder="Name"
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" id="proPrice" name="pro_price"
                            value="{{ old('pro_price', $product->product_price) }}"
                            placeholder="0.00"
                            style="background-color: #1e1e1e; color: #fff; border: 1px solid #e50914; padding: 6px 10px; font-size: 14px; border-radius: 5px;">
                        <span style="color: #ff4d4d; font-size: 12px;">
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select" name="pro_category"
                            ...
                            @foreach ($category as $cat)
                                <option value="{{ $cat->cat_id }}" {{ old('pro_category', $product->product_category) == $cat->cat_id ? 'selected' : '' }}>
                                    {{ $cat->cat_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="pro_description" id="proDescription" rows="2"
                            ...
                            style="background-color: #1e1e1e; color: #fff; border: 1px solid #e50914; font-size: 14px; padding: 6px 10px; border-radius: 5px;">{{ old('pro_description', $product->product_description) }}</textarea>
                        <span style="color: #ff4d4d; font-size: 12px;">
