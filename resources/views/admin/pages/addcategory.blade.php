    ...
    <div class="row g-4 justify-content-center">
        <div class="col-sm-12 col-xl-6">
            <div style="background-color: #121212; color: #ffffff; border-left: 6px solid #e50914; border-radius: 10px; box-shadow: 0 0 15px rgba(229, 9, 20, 0.2); padding: 20px;">
                <h4 class="mb-3" style="color: #e50914;">Add Category</h4>
                <form enctype="multipart/form-data" action="{{ route('admin.addcategory') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="catName" name="cat_name" value="{{ old('cat_name') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="cat_description" id="catDescription"
                            ...
                            style="background-color: #1e1e1e; color: #ffffff; border: 1px solid #e50914; padding: 8px 10px; border-radius: 5px; font-size: 14px;">{{ old('cat_description') }}</textarea>
                        <span style="color: #ff4d4d; font-size: 13px;">
